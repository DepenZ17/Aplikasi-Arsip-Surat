...
Date        : 2020
Developer   : Bayu Tutor
Pengembang  : Taufik Hidayat
Phone/WA    : 0812-9528-6858
Email       : taufik.hra@gmail.com
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <?php
                            if($_SESSION['admin'] == 1){
                                echo "<strong>Super Admin</strong>. Anda memiliki akses penuh terhadap sistem <br>Berikut adalah statistik data yang tersimpan dalam sistem.";
