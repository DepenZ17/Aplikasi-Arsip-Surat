...
<nav class="blue-grey darken-1">
    ...
    <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">home</i> SUDIN</a>
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            if(!empty($data['logo'])){
                                ...
                                echo '<img class="logoside" src="./asset/img/logowalkot.png"/>';
                            }
                            if(!empty($data['nama'])){
                            ...
                            if(!empty($data['alamat'])){
                                ...
                                echo '<p class="description-side">Ktr walikota jakarta timur</p>';
                            }
                        }
                    ?>
                </div>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">home</i> SUDIN</a></li>
            <li><div class="grs"></></li>
