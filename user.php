                                ...
                                <div class="col m12">
                                    <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only">
                                            <a href="?page=sett&sub=usr" class="judul"><i class="material-icons">people</i> Manajemen User</a>
                                        </li>
...
if ($_SESSION['username'] == $row['username']) {
    ...
    $currentUserLevel = $_SESSION['admin'];
    
    // Aturan akses
    if ($row['admin'] == 'Super Admin') {
        // Jika yang login adalah Administrator, tampilkan No Action
        if ($currentUserLevel == 2) {
            echo '<button class="btn small blue-grey waves-effect waves-light"><i class="material-icons">error</i> No Action</button>';
        } elseif ($currentUserLevel == 1) { // Super Admin
            // Super Admin dapat mengedit dan menghapus Super Admin lain
    ...
    } elseif ($row['admin'] == 'Administrator') {
        // Super Admin dapat mengedit dan menghapus Administrator
        if ($currentUserLevel == 1) { // Super Admin
            echo '<a class="btn small blue waves-effect waves-light" href="?page=sett&sub=usr&act=edit&id_user='.$row['id_user'].'">
                      <i class="material-icons">edit</i> EDIT</a>
                  <a class="btn small deep-orange waves-effect waves-light" href="?page=sett&sub=usr&act=del&id_user='.$row['id_user'].'"><i class="material-icons">delete</i> DEL</a>';
        } elseif ($currentUserLevel == 2) { // Administrator
            // Administrator dapat mengedit dan menghapus Administrator lain
            echo '<a class="btn small blue waves-effect waves-light" href="?page=sett&sub=usr&act=edit&id_user='.$row['id_user'].'">
                      <i class="material-icons">edit</i> EDIT</a>
                  <a class="btn small deep-orange waves-effect waves-light" href="?page=sett&sub=usr&act=del&id_user='.$row['id_user'].'"><i class="material-icons">delete</i> DEL</a>';
        }
    } elseif ($row['admin'] == 'User Biasa') {
        // Super Admin dapat mengedit dan menghapus User Biasa
        if ($currentUserLevel == 1) { // Super Admin
            echo '<a class="btn small blue waves-effect waves-light" href="?page=sett&sub=usr&act=edit&id_user='.$row['id_user'].'">
                      <i class="material-icons">edit</i> EDIT</a>
                  <a class="btn small deep-orange waves-effect waves-light" href="?page=sett&sub=usr&act=del&id_user='.$row['id_user'].'"><i class="material-icons">delete</i> DEL</a>';
        } elseif ($currentUserLevel == 2) { // Administrator
            // Administrator dapat mengedit dan menghapus User Biasa
            echo '<a class="btn small blue waves-effect waves-light" href="?page=sett&sub=usr&act=edit&id_user='.$row['id_user'].'">
                      <i class="material-icons">edit</i> EDIT</a>
                  <a class="btn small deep-orange waves-effect waves-light" href="?page=sett&sub=usr&act=del&id_user='.$row['id_user'].'"><i class="material-icons">delete</i> DEL</a>';
        }
