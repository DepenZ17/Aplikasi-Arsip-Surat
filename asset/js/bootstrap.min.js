...
+(function (t) {
  ...
  +(function (t) {
    ...
    (s.VERSION = "3.3.1"),
      ...
      (s.DEFAULTS = { toggle: !0, trigger: '[data-toggle="collapse"]' }),
      ...
      t(document).on(
        ...
        function (s) {
          ...
          var o = e(n),
            ...
            r = a ? "toggle" : t.extend({}, n.data(), { trigger: this });
          i.call(o, r);
        }
      );
  })(jQuery),
    ...
    (i.VERSION = "3.3.1"),
      ...
      (i.prototype.backdrop = function (e) {
        ...
        if (this.isShown && this.options.backdrop) {
          ...
          if (
            ((this.$backdrop = t('<div class="modal-backdrop ' + n + '" />')
        ...
        this.$body
          ...
          .map(function () {
            var s = t(this),
              ...
              o = /^#./.test(n) && t(n);
            return (
              (o && o.length && o.is(":visible") && [[o[e]().top + i, n]]) ||
              null
            );
          })
          .sort(function (t, e) {
